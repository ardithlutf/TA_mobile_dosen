...
class MyHomePageDatePicker extends StatefulWidget {
  @override
  MyHomePageDatePickerState createState() => MyHomePageDatePickerState();
}

class MyHomePageDatePickerState extends State<MyHomePageDatePicker> {
  @override
...
class BasicDateField_TglMulai extends StatelessWidget {
...
class BasicDateField_TglSelesai extends StatelessWidget {
  final format = DateFormat("yyyy-MM-dd");
  @override
  Widget build(BuildContext context) {
    return Column(children: <Widget>[
